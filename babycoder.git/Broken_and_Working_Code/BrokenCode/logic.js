...
$("#textPink").on("click", function() {
	...
	$("#funText").css("color", "pink") //error, pink is not quoted
})
...
$("#boxGrow").on("click", function() { //error, click is not quoted
	// Increase the size of the box.
	$("#box").animate({height:"+=35px", width:"+=35px"}, "fast");
})

// When the boxShrink button is clicked...
$("#boxShrink").on("click", function() { //error, click is not quoted
